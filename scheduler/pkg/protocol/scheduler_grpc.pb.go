...
func (c *schedulerClient) ScheduleBuild(ctx context.Context, in *BuildRequest, opts ...grpc.CallOption) (Scheduler_ScheduleBuildClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scheduler_ServiceDesc.Streams[0], "/Scheduler/ScheduleBuild", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *schedulerClient) ScheduleTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (Scheduler_ScheduleTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scheduler_ServiceDesc.Streams[1], "/Scheduler/ScheduleTask", opts...)
	if err != nil {
		return nil, err
	}
