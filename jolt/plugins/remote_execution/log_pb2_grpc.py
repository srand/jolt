...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in jolt/plugins/remote_execution/log_pb2_grpc.py depends on'
...
def add_LogStashServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('LogStash', rpc_method_handlers)
