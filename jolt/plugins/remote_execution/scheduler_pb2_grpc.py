...
class SchedulerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ScheduleBuild = channel.unary_unary(
                ...
                response_deserializer=jolt_dot_plugins_dot_remote__execution_dot_scheduler__pb2.BuildResponse.FromString,
                )
...
def add_SchedulerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ScheduleBuild': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=jolt_dot_plugins_dot_remote__execution_dot_scheduler__pb2.BuildResponse.SerializeToString,
            ),
...
class Scheduler(object):
    ...
    def ScheduleBuild(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Scheduler/ScheduleBuild',
            jolt_dot_plugins_dot_remote__execution_dot_scheduler__pb2.BuildRequest.SerializeToString,
            jolt_dot_plugins_dot_remote__execution_dot_scheduler__pb2.BuildResponse.FromString,
